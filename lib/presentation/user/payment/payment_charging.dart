...
class PaymentCharging extends StatefulWidget {
  final String? message;
  final String url;
  final void Function()? onSuccess;

  const PaymentCharging({
    Key? key,
    required this.url,
    this.onSuccess,
    this.message,
  ...
  @override
  State<PaymentCharging> createState() => _PaymentChargingState();
}

class _PaymentChargingState extends State<PaymentCharging> {
        ...
        NavigationDelegate(
          ...
          onNavigationRequest: (NavigationRequest request) {
            ...
            if (request.url.contains(successUrlPattern)) {
              ...
              context.go(RouterPath.paymentSuccess);
